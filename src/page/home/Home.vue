<template>
  <div>
    ...
    <mu-tabs :value="activeTab" @change="handleTabChange">
      <mu-tab value="colligate" title="首页"/>
      <mu-tab value="seekrent" title="幼儿院"/>
      <mu-tab value="Arent" title="小学"/>
      <mu-tab value="roommate" title="初中"/>
      <mu-tab value="roommate" title="高中"/>
      <mu-tab value="roommate" title="大学"/>
    </mu-tabs>
    ...
    <mu-popup popupClass="home-popup-bottom" position="bottom" :open="bottomPopup" @close="close('bottom')">
      ...
      <mu-content-block>
        <mu-row>
          <mu-col width="33" tablet="33" desktop="33" class="Label-border" v-for="item in LaBel_Data" :key="item.id"
                  :value="activeTab">

...
<div>
    ...
    <!--</div>-->
    <mu-sub-header>说点什么...</mu-sub-header>
        <mu-text-field class="signature-input" hintText="育儿心得..." :errorText="multiLineInputErrorText" @textOverflow="handleMultiLineOverflow" multiLine :rows="3" :rowsMax="6" :maxLength="100"/>
    <mu-bottom-sheet :open="genderSheet" @close="closegenderSheet">
    <mu-list @itemClick="closegenderSheet">
      <mu-list-item title="父亲" @click="GenDerSheet('父亲')"/>
      <mu-list-item title="母亲" @click="GenDerSheet('母亲')"/>
    </mu-list>
  </mu-bottom-sheet>
